...
{B} [{R}âœ”{B}] {Y}DEVELOPER  :{G} ADIL TOOR 

{B} [{R}âœ”{B}] {B}FACEBOOK   :{G} ADIL TOOR

{B} [{R}âœ”{B}] {nb}WHATSAPP   :{G} 03246940538

{B} [{R}âœ”{B}] {R}VERSION    :{G} 2.2.1
